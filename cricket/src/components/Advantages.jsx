  ...
  const advantages = [
    {
      ...
      description:
        "At JDbook, we know that sports are a big part of life for many people, and that's why we've created a platform that offers an extensive range of sports betting options. From cricket to basketball, football to tennis, we bring you a variety of games that allow you to bet and win.",
      highlights: [
